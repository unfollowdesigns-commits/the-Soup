...
| [spektrafilm](https://github.com/andreavolpato/spektrafilm) | GPLv3 (code), CC BY-SA 4.0 (profiles and LUTs) | **Not used.** Licence files and repository tree were inspected; the colour science was not read and nothing informed the engine. GPLv3 is unsuitable for linking into this app and the profile share-alike would attach to any LUT shipped from it. No code or profile is included. |
| [Film-Scan-Converter](https://github.com/kaimonmok/Film-Scan-Converter) | **GPLv3** (kaimonmok) | **Not used.** A Python/Tkinter RAW negative converter — inversion, base-mask sampling, colour balance. Readable for technique; GPLv3 rules out copying anything into this app. |
